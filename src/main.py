...
evolution = Evolution(grid_shape=(24,8,12), population_size=10, score_func=bridge_score, seed=1, agent_class=Agent, selection="novelty")
evolution.run(steps=40, sigma=0.002, generations=10)
